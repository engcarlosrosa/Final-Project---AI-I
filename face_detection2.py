...
# foto da webcam
lista_webcam = [ f for f in listdir("../FaceRecognition/webcam_rec") if isfile(join("../FaceRecognition/webcam_rec",f))]   # pasta que armazena o dataset
